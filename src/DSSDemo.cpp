  ...
  public:
    DssDemoController() : Node("DssDemoController")
    {
        ...
        imu_sub_ = create_subscription<sensor_msgs::msg::Imu>(
            "/dss/sensor/imu", rclcpp::SensorDataQoS(),
            [this](sensor_msgs::msg::Imu::SharedPtr msg) { this->last_imu_ = *msg; });
        ...
        image_sub_ = create_subscription<sensor_msgs::msg::Image>(
            "/dss/sensor/camera/rgb", rclcpp::QoS(rclcpp::KeepLast(10)).reliable(),
            [this](sensor_msgs::msg::Image::SharedPtr msg) { this->last_image_ = *msg; });
        ...
        */
        ...
        control_timer_ = create_wall_timer(std::chrono::milliseconds(1000 / send_rate_), [this]() {
            auto &vss = DSSVssClient::singleton();
