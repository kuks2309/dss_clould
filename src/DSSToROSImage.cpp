...
class DSSToROSImageNode : public DssBridgeNode
{
public:
    DSSToROSImageNode() : DssBridgeNode("DSSToROSImageNode", "dss.dssToROSImage.heartBeat")
    {
...
{
    return runBridgeNode<DSSToROSImageNode>(argc, argv, "DSSToROSImageNode");
}
