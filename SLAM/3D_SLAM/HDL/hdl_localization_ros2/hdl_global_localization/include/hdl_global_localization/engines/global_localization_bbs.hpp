...
protected:
  ...
  // 격자맵 1회성 발행은 늦게 붙은 구독자(RViz)가 놓친다 — 캐시 후 주기 재발행
  rclcpp::TimerBase::SharedPtr gridmap_republish_timer;
  nav_msgs::msg::OccupancyGrid::ConstSharedPtr last_gridmap;
  sensor_msgs::msg::PointCloud2 last_map_slice;
  bool has_map_slice = false;
