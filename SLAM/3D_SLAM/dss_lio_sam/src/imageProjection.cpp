...
private:
    ...
    rclcpp::Publisher<dss_lio_sam::msg::CloudInfo>::SharedPtr pubLaserCloudInfo;
    ...
    rclcpp::Service<dss_lio_sam::srv::Reset>::SharedPtr srvReset;
...
public:
            ...
            ParamServer("lio_sam_imageProjection", options), deskewFlag(0)
    {
        ...
        pubLaserCloudInfo = create_publisher<dss_lio_sam::msg::CloudInfo>(
            "lio_sam/deskew/cloud_info", qos);

        // Reset service for clearing queues (used by localization mode initial pose)
        srvReset = create_service<dss_lio_sam::srv::Reset>(
            "lio_sam/reset",
    ...
    void resetServiceCallback(
        const std::shared_ptr<dss_lio_sam::srv::Reset::Request> req,
        std::shared_ptr<dss_lio_sam::srv::Reset::Response> res)
    {
        (void)req;  // unused
