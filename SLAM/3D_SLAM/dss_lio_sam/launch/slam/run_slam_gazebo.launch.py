...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package='dss_lio_sam', executable='dss_lio_sam_imuPreintegration',
             name='dss_lio_sam_imuPreintegration',
             parameters=[parameter_file, {'use_sim_time': LaunchConfiguration('use_sim_time')}],
             output='screen'),
        Node(package='dss_lio_sam', executable='dss_lio_sam_imageProjection',
             name='dss_lio_sam_imageProjection',
             parameters=[parameter_file, {'use_sim_time': LaunchConfiguration('use_sim_time')}],
             output='screen'),
        Node(package='dss_lio_sam', executable='dss_lio_sam_featureExtraction',
             name='dss_lio_sam_featureExtraction',
             parameters=[parameter_file, {'use_sim_time': LaunchConfiguration('use_sim_time')}],
             output='screen'),
        Node(package='dss_lio_sam', executable='dss_lio_sam_mapOptimization',
