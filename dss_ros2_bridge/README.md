...
| 문서 | 내용 |
| --- | --- |
| [docs/sw_structure/dss_ros2_bridge/](docs/sw_structure/dss_ros2_bridge/) | 파일 의존 그래프 · 클래스 관계도 · 시퀀스 다이어그램 · 연결 관계표 |
| [docs/code_review/dss_ros2_bridge/](docs/code_review/dss_ros2_bridge/) | 코드 리뷰(함수·전역·의존성 인벤토리 + severity 평가) 및 실기 구동 delta |
| [docs/adr/](docs/adr/) | 설계 결정 기록 |
| [docs/code_updates/](docs/code_updates/) | 코드 수정 이력 |
